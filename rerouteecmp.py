...
def GetDist(t):
	"""
	Caching function for BellmanFord(): The distance to destination t is
	returned from cache distDict. If not in cache, call BellmanFord(t).
	"""
	d = list()
	try:
		d = distDict[t]
	except KeyError:
		dummy, d = BellmanFord(t)
		distDict[t] = d
	return d
